...
\def\par{\endgraf\endgroup\medbreak} \ninepoint\noindent\hang\hangafter=-2\hangindent=21pt
  \hbox to0pt{\hskip-\hangindent\dbend\hfill}}
\outer\def\danger{\d@nger}
\def\dd@nger{\medbreak\begingroup\clubpenalty=10000
  \def\par{\endgraf\endgroup\medbreak} \ninepoint\noindent\hang\hangafter=-2\hangindent=3pc
...
\def\pdfdestx#1{%
  \smash{\raise\the\baselineskip\hbox{\special{pdf:dest (#1) [@thispage /XYZ 0 @ypos null]}}}%
}
\def\pdflinkx#1#2{%
